...
//    private BlockingQueue<HttpContent> httpContentQueue = new LinkedBlockingQueue<>();
    private boolean endOfMessageAdded = false;
...
//        this.msg = msg;
        if (msg instanceof FullHttpResponse) {
            ...
            System.err.println("STATUS: " + ((FullHttpResponse) msg).getStatus());
            System.err.println("VERSION: " + ((FullHttpResponse) msg).getProtocolVersion());
            System.err.println();
            ...
            System.err.print(((FullHttpResponse) msg).content().toString(CharsetUtil.UTF_8));
            System.err.flush();
